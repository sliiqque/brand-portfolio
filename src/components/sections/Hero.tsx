        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center space-x-2 px-4 py-2 rounded-full border border-white/5 bg-white/5 backdrop-blur-md text-accent-cyan text-sm font-medium mb-8"
            >
              <Sparkles size={14} className="animate-spin-slow" />
              <span>Available for 2026 Partnerships</span>
            </motion.div>
