...
const projects = [
  {
    title: "NEPTUNE DEFI",
    description:
      "Multi-chain yield aggregator with real-time analytics and risk assessment tools.",
  ...
  },
  {
    title: "ORIGIN NFT",
    description:
      "Generative art marketplace with on-chain minting and royalty management.",
              ...
              <div className="group relative bento-card p-0 h-auto md:h-[500px] flex flex-col md:flex-row overflow-hidden border border-white/5">
                ...
                <div className="flex-1 p-8 md:p-12 flex flex-col justify-between z-10">
                  <div>
                    ...
                    <h3 className="text-4xl md:text-5xl font-bold mb-6 group-hover:text-accent-violet transition-colors">
                      {project.title}
                    </h3>
                  ...
                  <div className="flex flex-wrap gap-8 items-center pt-8 border-t border-white/5">
                    ...
                    <div className="ml-auto flex gap-4">
                      ...
                      <Link
                        href={project.link}
                        className="p-3 rounded-full bg-accent-violet text-white hover:shadow-glow transition-all"
                      >
